...
- build(deps): `al.essio.dev/pkg/shellescape` from 1.5.1 to 1.6.0 ([#1478](https://github.com/fastly/cli/pull/1478))
- build(deps): `cel.dev/expr` from 0.23.1 to 0.24.0 ([#1478](https://github.com/fastly/cli/pull/1478))
- build(deps): `cloud.google.com/go/ai` from 0.11.0 to 0.11.1 ([#1478](https://github.com/fastly/cli/pull/1478))
- build(deps): `cloud.google.com/go/auth` from 0.16.0 to 0.16.1 ([#1478](https://github.com/fastly/cli/pull/1478))
- build(deps): `cloud.google.com/go/iam` from 1.5.0 to 1.5.2 ([#1478](https://github.com/fastly/cli/pull/1478))
- build(deps): `cloud.google.com/go/storage` from 1.52.0 to 1.53.0 ([#1478](https://github.com/fastly/cli/pull/1478))
- build(deps): `dario.cat/mergo` from 1.0.1 to 1.0.2 ([#1478](https://github.com/fastly/cli/pull/1478))
- build(deps): `github.com/aws/aws-sdk-go-v2/feature/s3/manager` from 1.17.74 to 1.17.75 ([#1478](https://github.com/fastly/cli/pull/1478))
- build(deps): `github.com/google/ko` from 0.17.1 to 0.18.0 ([#1478](https://github.com/fastly/cli/pull/1478))
- build(deps): `github.com/google/safetext` from 0.0.0-20220905092116-b49f7bc46da2 to 0.0.0-20240722112252-5a72de7e7962 ([#1478](https://github.com/fastly/cli/pull/1478))
- build(deps): `github.com/ipfs/go-ipld-format` from 0.6.0 to 0.6.1 ([#1478](https://github.com/fastly/cli/pull/1478))
- build(deps): `github.com/ipfs/go-log/v2` from 2.5.1 to 2.6.0 ([#1478](https://github.com/fastly/cli/pull/1478))
- build(deps): `github.com/jedisct1/go-minisign` from 0.0.0-20230811132847-661be99b8267 to 0.0.0-20241212093149-d2f9f49435c7 ([#1478](https://github.com/fastly/cli/pull/1478))
- build(deps): `github.com/letsencrypt/boulder` from 0.0.0-20240620165639-de9c06129bec to 0.0.0-20250411005613-d800055fe666 ([#1478](https://github.com/fastly/cli/pull/1478))
- build(deps): `github.com/olekukonko/tablewriter` from 0.0.5 to 1.0.3 ([#1478](https://github.com/fastly/cli/pull/1478))
- build(deps): `github.com/sagikazarmark/locafero` from 0.7.0 to 0.9.0 ([#1478](https://github.com/fastly/cli/pull/1478))
- build(deps): `github.com/securego/gosec/v2` from 2.22.3 to 2.22.4 ([#1478](https://github.com/fastly/cli/pull/1478))
- build(deps): `github.com/sigstore/rekor` from 1.3.9 to 1.3.10 ([#1478](https://github.com/fastly/cli/pull/1478))
