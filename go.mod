...
require (
	...
	github.com/trufflesecurity/trufflehog/v3 v3.62.1
...
require (
	...
	github.com/TheZeroSlave/zapsentry v1.19.0 // indirect
	...
	github.com/trufflesecurity/disk-buffer-reader v0.1.9 // indirect
