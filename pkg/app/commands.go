...
func defineCommands(
	...
	computeHashsum := compute.NewHashsumCommand(computeCmdRoot.CmdClause, globals, computeBuild, data)
	...
	secretstoreGetStore := secretstore.NewGetStoreCommand(secretstoreCmdRoot.CmdClause, globals, data)
	...
	secretstoreGetSecret := secretstore.NewGetSecretCommand(secretstoreSecretCmdRoot.CmdClause, globals, data)
