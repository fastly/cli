...
func Run(args []string, env config.Environment, file config.ConfigFile, configFilePath string, cf APIClientFactory, httpClient api.HTTPClient, versioner update.Versioner, in io.Reader, out io.Writer) error {
