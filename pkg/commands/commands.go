...
import (
	...
	"github.com/fastly/cli/v10/pkg/commands/acl"
	"github.com/fastly/cli/v10/pkg/commands/aclentry"
	"github.com/fastly/cli/v10/pkg/commands/authtoken"
	"github.com/fastly/cli/v10/pkg/commands/backend"
	"github.com/fastly/cli/v10/pkg/commands/compute"
	"github.com/fastly/cli/v10/pkg/commands/config"
	"github.com/fastly/cli/v10/pkg/commands/configstore"
	"github.com/fastly/cli/v10/pkg/commands/configstoreentry"
	"github.com/fastly/cli/v10/pkg/commands/dictionary"
	"github.com/fastly/cli/v10/pkg/commands/dictionaryentry"
	"github.com/fastly/cli/v10/pkg/commands/domain"
	"github.com/fastly/cli/v10/pkg/commands/healthcheck"
	"github.com/fastly/cli/v10/pkg/commands/install"
	"github.com/fastly/cli/v10/pkg/commands/ip"
	"github.com/fastly/cli/v10/pkg/commands/kvstore"
	"github.com/fastly/cli/v10/pkg/commands/kvstoreentry"
	"github.com/fastly/cli/v10/pkg/commands/logging"
	"github.com/fastly/cli/v10/pkg/commands/logging/azureblob"
	"github.com/fastly/cli/v10/pkg/commands/logging/bigquery"
	"github.com/fastly/cli/v10/pkg/commands/logging/cloudfiles"
	"github.com/fastly/cli/v10/pkg/commands/logging/datadog"
	"github.com/fastly/cli/v10/pkg/commands/logging/digitalocean"
	"github.com/fastly/cli/v10/pkg/commands/logging/elasticsearch"
	"github.com/fastly/cli/v10/pkg/commands/logging/ftp"
	"github.com/fastly/cli/v10/pkg/commands/logging/gcs"
	"github.com/fastly/cli/v10/pkg/commands/logging/googlepubsub"
	"github.com/fastly/cli/v10/pkg/commands/logging/heroku"
	"github.com/fastly/cli/v10/pkg/commands/logging/honeycomb"
	"github.com/fastly/cli/v10/pkg/commands/logging/https"
	"github.com/fastly/cli/v10/pkg/commands/logging/kafka"
	"github.com/fastly/cli/v10/pkg/commands/logging/kinesis"
	"github.com/fastly/cli/v10/pkg/commands/logging/loggly"
	"github.com/fastly/cli/v10/pkg/commands/logging/logshuttle"
	"github.com/fastly/cli/v10/pkg/commands/logging/newrelic"
	"github.com/fastly/cli/v10/pkg/commands/logging/newrelicotlp"
	"github.com/fastly/cli/v10/pkg/commands/logging/openstack"
	"github.com/fastly/cli/v10/pkg/commands/logging/papertrail"
	"github.com/fastly/cli/v10/pkg/commands/logging/s3"
	"github.com/fastly/cli/v10/pkg/commands/logging/scalyr"
	"github.com/fastly/cli/v10/pkg/commands/logging/sftp"
	"github.com/fastly/cli/v10/pkg/commands/logging/splunk"
	"github.com/fastly/cli/v10/pkg/commands/logging/sumologic"
	"github.com/fastly/cli/v10/pkg/commands/logging/syslog"
	"github.com/fastly/cli/v10/pkg/commands/logtail"
	"github.com/fastly/cli/v10/pkg/commands/pop"
	"github.com/fastly/cli/v10/pkg/commands/products"
	"github.com/fastly/cli/v10/pkg/commands/profile"
	"github.com/fastly/cli/v10/pkg/commands/purge"
	"github.com/fastly/cli/v10/pkg/commands/ratelimit"
	"github.com/fastly/cli/v10/pkg/commands/resourcelink"
	"github.com/fastly/cli/v10/pkg/commands/secretstore"
	"github.com/fastly/cli/v10/pkg/commands/secretstoreentry"
	"github.com/fastly/cli/v10/pkg/commands/service"
	"github.com/fastly/cli/v10/pkg/commands/serviceauth"
	"github.com/fastly/cli/v10/pkg/commands/serviceversion"
	"github.com/fastly/cli/v10/pkg/commands/shellcomplete"
	"github.com/fastly/cli/v10/pkg/commands/sso"
	"github.com/fastly/cli/v10/pkg/commands/stats"
	tlsconfig "github.com/fastly/cli/v10/pkg/commands/tls/config"
	tlscustom "github.com/fastly/cli/v10/pkg/commands/tls/custom"
	tlscustomactivation "github.com/fastly/cli/v10/pkg/commands/tls/custom/activation"
	tlscustomcertificate "github.com/fastly/cli/v10/pkg/commands/tls/custom/certificate"
	tlscustomdomain "github.com/fastly/cli/v10/pkg/commands/tls/custom/domain"
	tlscustomprivatekey "github.com/fastly/cli/v10/pkg/commands/tls/custom/privatekey"
	tlsplatform "github.com/fastly/cli/v10/pkg/commands/tls/platform"
	tlssubscription "github.com/fastly/cli/v10/pkg/commands/tls/subscription"
	"github.com/fastly/cli/v10/pkg/commands/update"
	"github.com/fastly/cli/v10/pkg/commands/user"
	"github.com/fastly/cli/v10/pkg/commands/vcl"
	"github.com/fastly/cli/v10/pkg/commands/vcl/condition"
	"github.com/fastly/cli/v10/pkg/commands/vcl/custom"
	"github.com/fastly/cli/v10/pkg/commands/vcl/snippet"
