...
// UpdateCommand calls the Fastly API to update a Microsoft Teams notification integration.
...
func NewUpdateCommand(parent argparser.Registerer, g *global.Data) *UpdateCommand {
	...
	c.CmdClause = parent.Command("update", "Update a Microsoft Teams notification integration")
...
func (c *UpdateCommand) Exec(_ io.Reader, out io.Writer) error {
	...
	text.Success(out, "Updated Microsoft Teams integration (id: %s)", c.ID)
	return nil
}
