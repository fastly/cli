...
// CreateCommand calls the Fastly API to create a PagerDuty notification integration.
...
func NewCreateCommand(parent argparser.Registerer, g *global.Data) *CreateCommand {
	...
	c.CmdClause = parent.Command("create", "Create a PagerDuty notification integration").Alias("add")
...
func (c *CreateCommand) Exec(_ io.Reader, out io.Writer) error {
	...
	text.Success(out, "Created PagerDuty integration '%s' (id: %s)", c.IntegrationName, fastly.ToValue(o.ID))
	return nil
}
