...
import (
	...
	sub "github.com/fastly/cli/pkg/commands/integration/slack"
...
func TestCreateCommand(t *testing.T) {
	...
	scenarios := []testutil.CLIScenario{
		...
		},
		{
			...
			WantOutput: fstfmt.Success("Created Slack integration '%s' (id: %s)", integrationName, integrationID),
		},
		{
...
func TestUpdateCommand(t *testing.T) {
	...
	scenarios := []testutil.CLIScenario{
		...
		},
		{
			...
			WantOutput: fstfmt.Success("Updated Slack integration (id: %s)", integrationID),
		},
		{
