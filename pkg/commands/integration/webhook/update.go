...
// UpdateCommand calls the Fastly API to update a Webhook notification integration.
...
func NewUpdateCommand(parent argparser.Registerer, g *global.Data) *UpdateCommand {
	...
	c.CmdClause = parent.Command("update", "Update a Webhook notification integration")
...
func (c *UpdateCommand) Exec(_ io.Reader, out io.Writer) error {
	...
	text.Success(out, "Updated Webhook integration (id: %s)", c.ID)
	return nil
}
