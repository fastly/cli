...
func (c *DeleteCommand) Exec(_ io.Reader, out io.Writer) error {
	...
	if err := c.Globals.APIClient.DeleteLogentries(&c.Input); err != nil {
		c.Globals.ErrLog.Add(err)
		return err
	}

	text.Success(out, "Deleted Logentries logging endpoint %s (service %s version %d)", c.Input.Name, c.Input.ServiceID, c.Input.ServiceVersion)
	return nil
}
