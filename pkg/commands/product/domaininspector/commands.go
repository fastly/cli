...
import (
	...
	product "github.com/fastly/go-fastly/v9/fastly/products/domaininspector"
...
const CommandName = "domain_inspector"

// NewRootCommand returns a new command registered in the parent.
func NewRootCommand(parent argparser.Registerer, g *global.Data) *RootCommand {
	var c RootCommand
	c.Globals = g
	c.CmdClause = parent.Command(CommandName, "Enable and disable the Domain Inspector product")
	return &c
}
