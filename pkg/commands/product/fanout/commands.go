...
import (
	...
	product "github.com/fastly/go-fastly/v9/fastly/products/fanout"
...
const CommandName = "fanout"

// NewRootCommand returns a new command registered in the parent.
func NewRootCommand(parent argparser.Registerer, g *global.Data) *RootCommand {
	var c RootCommand
	c.Globals = g
	c.CmdClause = parent.Command(CommandName, "Enable and disable the Fanout product")
	return &c
}
