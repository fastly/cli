...
import (
	...
	product "github.com/fastly/go-fastly/v9/fastly/products/logexplorerinsights"
...
func NewRootCommand(parent argparser.Registerer, g *global.Data) *RootCommand {
	var c RootCommand
	c.Globals = g
	c.CmdClause = parent.Command(CommandName, "Enable and disable the Log Explorer & Insights product")
	return &c
}
