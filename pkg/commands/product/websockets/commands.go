...
import (
	...
	product "github.com/fastly/go-fastly/v9/fastly/products/websockets"
...
const CommandName = "websockets"

// NewRootCommand returns a new command registered in the parent.
func NewRootCommand(parent argparser.Registerer, g *global.Data) *RootCommand {
	var c RootCommand
	c.Globals = g
	c.CmdClause = parent.Command(CommandName, "Enable and disable the WebSockets product")
	return &c
}
