...
func TestCloudfilesCreate(t *testing.T) {
	...
	scenarios := []struct {
		...
		{
			args: args("service logging cloudfiles create --service-id 123 --version 1 --name log --user username --bucket log --access-key foo --autoclone"),
			api: mock.API{
		...
		{
			args: args("service logging cloudfiles create --service-id 123 --version 1 --name log --user username --bucket log --access-key foo --compression-codec zstd --gzip-level 9 --autoclone"),
			api: mock.API{
				ListVersionsFn: testutil.ListVersions,
				CloneVersionFn: testutil.CloneVersionResult(4),
			},
...
func TestCloudfilesList(t *testing.T) {
	...
	scenarios := []struct {
		...
		{
			args: args("service logging cloudfiles list --service-id 123 --version 1"),
			api: mock.API{
				ListVersionsFn:   testutil.ListVersions,
		...
		{
			args: args("service logging cloudfiles list --service-id 123 --version 1 --verbose"),
			api: mock.API{
				ListVersionsFn:   testutil.ListVersions,
				ListCloudfilesFn: listCloudfilesOK,
			},
		...
		{
			args: args("service logging cloudfiles list --service-id 123 --version 1 -v"),
			api: mock.API{
				ListVersionsFn:   testutil.ListVersions,
				ListCloudfilesFn: listCloudfilesOK,
			},
		...
		{
			args: args("service logging cloudfiles --verbose list --service-id 123 --version 1"),
			api: mock.API{
				ListVersionsFn:   testutil.ListVersions,
				ListCloudfilesFn: listCloudfilesOK,
			},
		...
		{
			args: args("service logging -v cloudfiles list --service-id 123 --version 1"),
			api: mock.API{
				ListVersionsFn:   testutil.ListVersions,
				ListCloudfilesFn: listCloudfilesOK,
			},
...
func TestCloudfilesDescribe(t *testing.T) {
	...
	scenarios := []struct {
		...
		{
			args:      args("service logging cloudfiles describe --service-id 123 --version 1"),
			wantError: "error parsing arguments: required flag --name not provided",
		},
		{
			args: args("service logging cloudfiles describe --service-id 123 --version 1 --name logs"),
			api: mock.API{
				ListVersionsFn:  testutil.ListVersions,
...
func TestCloudfilesUpdate(t *testing.T) {
	...
	scenarios := []struct {
		...
		{
			args:      args("service logging cloudfiles update --service-id 123 --version 1 --new-name log"),
			wantError: "error parsing arguments: required flag --name not provided",
		},
		{
			args: args("service logging cloudfiles update --service-id 123 --version 1 --name logs --new-name log --autoclone"),
			api: mock.API{
				ListVersionsFn:     testutil.ListVersions,
				CloneVersionFn:     testutil.CloneVersionResult(4),
...
func TestCloudfilesDelete(t *testing.T) {
	...
	scenarios := []struct {
		...
		{
			args:      args("service logging cloudfiles delete --service-id 123 --version 1"),
			wantError: "error parsing arguments: required flag --name not provided",
		},
		{
			args: args("service logging cloudfiles delete --service-id 123 --version 1 --name logs --autoclone"),
			api: mock.API{
				ListVersionsFn:     testutil.ListVersions,
				CloneVersionFn:     testutil.CloneVersionResult(4),
