...
func TestHerokuCreate(t *testing.T) {
	...
	scenarios := []struct {
		...
		{
			args: args("service logging heroku create --service-id 123 --version 1 --name log --auth-token abc --url example.com --autoclone"),
			api: mock.API{
...
func TestHerokuList(t *testing.T) {
	...
	scenarios := []struct {
		...
		{
			args: args("service logging heroku list --service-id 123 --version 1"),
			api: mock.API{
				ListVersionsFn: testutil.ListVersions,
		...
		{
			args: args("service logging heroku list --service-id 123 --version 1 --verbose"),
			api: mock.API{
				ListVersionsFn: testutil.ListVersions,
				ListHerokusFn:  listHerokusOK,
			},
		...
		{
			args: args("service logging heroku list --service-id 123 --version 1 -v"),
			api: mock.API{
				ListVersionsFn: testutil.ListVersions,
				ListHerokusFn:  listHerokusOK,
			},
		...
		{
			args: args("service logging heroku --verbose list --service-id 123 --version 1"),
			api: mock.API{
				ListVersionsFn: testutil.ListVersions,
				ListHerokusFn:  listHerokusOK,
			},
		...
		{
			args: args("service logging -v heroku list --service-id 123 --version 1"),
			api: mock.API{
				ListVersionsFn: testutil.ListVersions,
				ListHerokusFn:  listHerokusOK,
			},
...
func TestHerokuDescribe(t *testing.T) {
	...
	scenarios := []struct {
		...
		{
			args:      args("service logging heroku describe --service-id 123 --version 1"),
			wantError: "error parsing arguments: required flag --name not provided",
		},
		{
			args: args("service logging heroku describe --service-id 123 --version 1 --name logs"),
			api: mock.API{
				ListVersionsFn: testutil.ListVersions,
...
func TestHerokuUpdate(t *testing.T) {
	...
	scenarios := []struct {
		...
		{
			args:      args("service logging heroku update --service-id 123 --version 1 --new-name log"),
			wantError: "error parsing arguments: required flag --name not provided",
		},
		{
			args: args("service logging heroku update --service-id 123 --version 1 --name logs --new-name log --autoclone"),
			api: mock.API{
				ListVersionsFn: testutil.ListVersions,
				CloneVersionFn: testutil.CloneVersionResult(4),
...
func TestHerokuDelete(t *testing.T) {
	...
	scenarios := []struct {
		...
		{
			args:      args("service logging heroku delete --service-id 123 --version 1"),
			wantError: "error parsing arguments: required flag --name not provided",
		},
		{
			args: args("service logging heroku delete --service-id 123 --version 1 --name logs --autoclone"),
			api: mock.API{
				ListVersionsFn: testutil.ListVersions,
				CloneVersionFn: testutil.CloneVersionResult(4),
