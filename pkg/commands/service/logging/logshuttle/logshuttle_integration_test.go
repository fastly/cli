...
func TestLogshuttleCreate(t *testing.T) {
	...
	scenarios := []struct {
		...
		{
			args: args("service logging logshuttle create --service-id 123 --version 1 --name log --url example.com --auth-token abc --autoclone"),
			api: mock.API{
...
func TestLogshuttleList(t *testing.T) {
	...
	scenarios := []struct {
		...
		{
			args: args("service logging logshuttle list --service-id 123 --version 1"),
			api: mock.API{
				ListVersionsFn:    testutil.ListVersions,
		...
		{
			args: args("service logging logshuttle list --service-id 123 --version 1 --verbose"),
			api: mock.API{
				ListVersionsFn:    testutil.ListVersions,
				ListLogshuttlesFn: listLogshuttlesOK,
			},
		...
		{
			args: args("service logging logshuttle list --service-id 123 --version 1 -v"),
			api: mock.API{
				ListVersionsFn:    testutil.ListVersions,
				ListLogshuttlesFn: listLogshuttlesOK,
			},
		...
		{
			args: args("service logging logshuttle --verbose list --service-id 123 --version 1"),
			api: mock.API{
				ListVersionsFn:    testutil.ListVersions,
				ListLogshuttlesFn: listLogshuttlesOK,
			},
		...
		{
			args: args("service logging -v logshuttle list --service-id 123 --version 1"),
			api: mock.API{
				ListVersionsFn:    testutil.ListVersions,
				ListLogshuttlesFn: listLogshuttlesOK,
			},
...
func TestLogshuttleDescribe(t *testing.T) {
	...
	scenarios := []struct {
		...
		{
			args:      args("service logging logshuttle describe --service-id 123 --version 1"),
			wantError: "error parsing arguments: required flag --name not provided",
		},
		{
			args: args("service logging logshuttle describe --service-id 123 --version 1 --name logs"),
			api: mock.API{
				ListVersionsFn:  testutil.ListVersions,
...
func TestLogshuttleUpdate(t *testing.T) {
	...
	scenarios := []struct {
		...
		{
			args:      args("service logging logshuttle update --service-id 123 --version 1 --new-name log"),
			wantError: "error parsing arguments: required flag --name not provided",
		},
		{
			args: args("service logging logshuttle update --service-id 123 --version 1 --name logs --new-name log --autoclone"),
			api: mock.API{
				ListVersionsFn:     testutil.ListVersions,
				CloneVersionFn:     testutil.CloneVersionResult(4),
...
func TestLogshuttleDelete(t *testing.T) {
	...
	scenarios := []struct {
		...
		{
			args:      args("service logging logshuttle delete --service-id 123 --version 1"),
			wantError: "error parsing arguments: required flag --name not provided",
		},
		{
			args: args("service logging logshuttle delete --service-id 123 --version 1 --name logs --autoclone"),
			api: mock.API{
				ListVersionsFn:     testutil.ListVersions,
				CloneVersionFn:     testutil.CloneVersionResult(4),
