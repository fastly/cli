...
func TestOpenstackCreate(t *testing.T) {
	...
	scenarios := []struct {
		...
		{
			args: args("service logging openstack create --service-id 123 --version 1 --name log --bucket log --access-key foo --user user --url https://example.com --autoclone"),
			api: mock.API{
		...
		{
			args: args("service logging openstack create --service-id 123 --version 1 --name log --bucket log --access-key foo --user user --url https://example.com --compression-codec zstd --gzip-level 9 --autoclone"),
			api: mock.API{
				ListVersionsFn: testutil.ListVersions,
				CloneVersionFn: testutil.CloneVersionResult(4),
			},
...
func TestOpenstackList(t *testing.T) {
	...
	scenarios := []struct {
		...
		{
			args: args("service logging openstack list --service-id 123 --version 1"),
			api: mock.API{
				ListVersionsFn:   testutil.ListVersions,
		...
		{
			args: args("service logging openstack list --service-id 123 --version 1 --verbose"),
			api: mock.API{
				ListVersionsFn:   testutil.ListVersions,
				ListOpenstacksFn: listOpenstacksOK,
			},
		...
		{
			args: args("service logging openstack list --service-id 123 --version 1 -v"),
			api: mock.API{
				ListVersionsFn:   testutil.ListVersions,
				ListOpenstacksFn: listOpenstacksOK,
			},
		...
		{
			args: args("service logging openstack --verbose list --service-id 123 --version 1"),
			api: mock.API{
				ListVersionsFn:   testutil.ListVersions,
				ListOpenstacksFn: listOpenstacksOK,
			},
		...
		{
			args: args("service logging -v openstack list --service-id 123 --version 1"),
			api: mock.API{
				ListVersionsFn:   testutil.ListVersions,
				ListOpenstacksFn: listOpenstacksOK,
			},
...
func TestOpenstackDescribe(t *testing.T) {
	...
	scenarios := []struct {
		...
		{
			args:      args("service logging openstack describe --service-id 123 --version 1"),
			wantError: "error parsing arguments: required flag --name not provided",
		},
		{
			args: args("service logging openstack describe --service-id 123 --version 1 --name logs"),
			api: mock.API{
				ListVersionsFn: testutil.ListVersions,
...
func TestOpenstackUpdate(t *testing.T) {
	...
	scenarios := []struct {
		...
		{
			args:      args("service logging openstack update --service-id 123 --version 1 --new-name log"),
			wantError: "error parsing arguments: required flag --name not provided",
		},
		{
			args: args("service logging openstack update --service-id 123 --version 1 --name logs --new-name log --autoclone"),
			api: mock.API{
				ListVersionsFn:    testutil.ListVersions,
				CloneVersionFn:    testutil.CloneVersionResult(4),
...
func TestOpenstackDelete(t *testing.T) {
	...
	scenarios := []struct {
		...
		{
			args:      args("service logging openstack delete --service-id 123 --version 1"),
			wantError: "error parsing arguments: required flag --name not provided",
		},
		{
			args: args("service logging openstack delete --service-id 123 --version 1 --name logs --autoclone"),
			api: mock.API{
				ListVersionsFn:    testutil.ListVersions,
				CloneVersionFn:    testutil.CloneVersionResult(4),
