...
func TestSumologicCreate(t *testing.T) {
	...
	scenarios := []struct {
		...
		{
			args: args("service logging sumologic create --service-id 123 --version 1 --name log --url example.com --autoclone"),
			api: mock.API{
...
func TestSumologicList(t *testing.T) {
	...
	scenarios := []struct {
		...
		{
			args: args("service logging sumologic list --service-id 123 --version 1"),
			api: mock.API{
				ListVersionsFn:   testutil.ListVersions,
		...
		{
			args: args("service logging sumologic list --service-id 123 --version 1 --verbose"),
			api: mock.API{
				ListVersionsFn:   testutil.ListVersions,
				ListSumologicsFn: listSumologicsOK,
			},
		...
		{
			args: args("service logging sumologic list --service-id 123 --version 1 -v"),
			api: mock.API{
				ListVersionsFn:   testutil.ListVersions,
				ListSumologicsFn: listSumologicsOK,
			},
		...
		{
			args: args("service logging sumologic --verbose list --service-id 123 --version 1"),
			api: mock.API{
				ListVersionsFn:   testutil.ListVersions,
				ListSumologicsFn: listSumologicsOK,
			},
		...
		{
			args: args("service logging -v sumologic list --service-id 123 --version 1"),
			api: mock.API{
				ListVersionsFn:   testutil.ListVersions,
				ListSumologicsFn: listSumologicsOK,
			},
...
func TestSumologicDescribe(t *testing.T) {
	...
	scenarios := []struct {
		...
		{
			args:      args("service logging sumologic describe --service-id 123 --version 1"),
			wantError: "error parsing arguments: required flag --name not provided",
		},
		{
			args: args("service logging sumologic describe --service-id 123 --version 1 --name logs"),
			api: mock.API{
				ListVersionsFn: testutil.ListVersions,
...
func TestSumologicUpdate(t *testing.T) {
	...
	scenarios := []struct {
		...
		{
			args:      args("service logging sumologic update --service-id 123 --version 1 --new-name log"),
			wantError: "error parsing arguments: required flag --name not provided",
		},
		{
			args: args("service logging sumologic update --service-id 123 --version 1 --name logs --new-name log --autoclone"),
			api: mock.API{
				ListVersionsFn:    testutil.ListVersions,
				CloneVersionFn:    testutil.CloneVersionResult(4),
...
func TestSumologicDelete(t *testing.T) {
	...
	scenarios := []struct {
		...
		{
			args:      args("service logging sumologic delete --service-id 123 --version 1"),
			wantError: "error parsing arguments: required flag --name not provided",
		},
		{
			args: args("service logging sumologic delete --service-id 123 --version 1 --name logs --autoclone"),
			api: mock.API{
				ListVersionsFn:    testutil.ListVersions,
				CloneVersionFn:    testutil.CloneVersionResult(4),
