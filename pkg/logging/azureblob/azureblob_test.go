...
func updateCommandAll() *UpdateCommand {
	return &UpdateCommand{
		...
		Container:         common.OptionalString{Optional: common.Optional{Valid: true}, Value: "new2"},
		AccountName:       common.OptionalString{Optional: common.Optional{Valid: true}, Value: "new3"},
		SASToken:          common.OptionalString{Optional: common.Optional{Valid: true}, Value: "new4"},
		...
		TimestampFormat:   common.OptionalString{Optional: common.Optional{Valid: true}, Value: "new9"},
