...
// DeleteCommand calls the Fastly API to delete Azure Blob Storage logging endpoints.
...
func (c *DeleteCommand) Exec(in io.Reader, out io.Writer) error {
	...
	text.Success(out, "Deleted Azure Blob Storage logging endpoint %s (service %s version %d)", c.Input.Name, c.Input.Service, c.Input.Version)
	return nil
}
