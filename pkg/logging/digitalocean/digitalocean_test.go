...
func createCommandAll() *CreateCommand {
	return &CreateCommand{
		...
		AccessKey:         "access",
		SecretKey:         "secret",
		Domain:            common.OptionalString{Optional: common.Optional{Valid: true}, Value: "nyc3.digitaloceanspaces.com"},
...
func updateCommandAll() *UpdateCommand {
	return &UpdateCommand{
		...
		Domain:            common.OptionalString{Optional: common.Optional{Valid: true}, Value: "new3"},
		AccessKey:         common.OptionalString{Optional: common.Optional{Valid: true}, Value: "new4"},
		SecretKey:         common.OptionalString{Optional: common.Optional{Valid: true}, Value: "new5"},
		...
		PublicKey:         common.OptionalString{Optional: common.Optional{Valid: true}, Value: "new12"},
	}
}
