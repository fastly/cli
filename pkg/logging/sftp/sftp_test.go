...
func createCommandAll() *CreateCommand {
	return &CreateCommand{
		...
		User:              "user",
		SSHKnownHosts:     knownHosts(),
		Port:              common.OptionalUint{Optional: common.Optional{Valid: true}, Value: 80},
		...
		SecretKey:         common.OptionalString{Optional: common.Optional{Valid: true}, Value: sshPrivateKey()},
		Path:              common.OptionalString{Optional: common.Optional{Valid: true}, Value: "/log"},
...
func updateCommandAll() *UpdateCommand {
	return &UpdateCommand{
		...
		SSHKnownHosts:     common.OptionalString{Optional: common.Optional{Valid: true}, Value: "new4"},
		Port:              common.OptionalUint{Optional: common.Optional{Valid: true}, Value: 81},
		Password:          common.OptionalString{Optional: common.Optional{Valid: true}, Value: "new5"},
		PublicKey:         common.OptionalString{Optional: common.Optional{Valid: true}, Value: "new6"},
		SecretKey:         common.OptionalString{Optional: common.Optional{Valid: true}, Value: "new7"},
		Path:              common.OptionalString{Optional: common.Optional{Valid: true}, Value: "new8"},
		Period:            common.OptionalUint{Optional: common.Optional{Valid: true}, Value: 3601},
		Format:            common.OptionalString{Optional: common.Optional{Valid: true}, Value: "new9"},
