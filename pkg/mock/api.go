...
type API struct {
	...
	NewListKVStoreKeysPaginatorFn     func(i *fastly.ListKVStoreKeysInput) *fastly.ListKVStoreKeysPaginator
...
func (m API) NewListKVStoreKeysPaginator(i *fastly.ListKVStoreKeysInput) *fastly.ListKVStoreKeysPaginator {
