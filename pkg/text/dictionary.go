...
// PrintDictionaryInfo pretty prints a fastly.DictionaryInfo structure in verbose
...
func PrintDictionaryInfo(out io.Writer, prefix string, d *fastly.Dictionary) {
